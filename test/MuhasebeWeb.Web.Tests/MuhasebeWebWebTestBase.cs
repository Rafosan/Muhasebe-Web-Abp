...
using MuhasebeWeb.Models.TokenAuth;
...
{
    public abstract class MuhasebeWebWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MuhasebeWebWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MuhasebeWebWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MuhasebeWebDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MuhasebeWebDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MuhasebeWebDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MuhasebeWebDbContext, Task<T>> func)
        {
            T result;
