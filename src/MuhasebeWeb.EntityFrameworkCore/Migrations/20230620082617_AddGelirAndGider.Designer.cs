...
{
    [DbContext(typeof(MuhasebeWebDbContext))]
    [Migration("20230620082617_AddGelirAndGider")]
    partial class AddGelirAndGider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MuhasebeWeb.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MuhasebeWeb.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MuhasebeWeb.Entity.AlimTurleri.AlimTuruEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuhasebeWeb.Entity.AlimUsulu.AlimUsuluEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuhasebeWeb.Entity.Birim.BirimEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuhasebeWeb.Entity.Gelir.GelirEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuhasebeWeb.Entity.Gider.GiderEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuhasebeWeb.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MuhasebeWeb.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MuhasebeWeb.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MuhasebeWeb.Authorization.Roles.Role", b =>
                {
                    b.HasOne("MuhasebeWeb.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("MuhasebeWeb.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("MuhasebeWeb.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
